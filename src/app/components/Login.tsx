  ...
  return (
    <div className="w-full h-[100vh] flex justify-center items-center">
      <form
        ...
        className="text-center border rounded-md bg-gray-100 px-10 py-10 space-y-4 w-[500px]"
      >
        ...
        <div>
          <button
            type="submit"
            className="px-2 py-1 border-[0.5px] border-gray-500 rounded-md w-full cursor-pointer bg-gray-800 text-white font-semibold text-[15px] mt-4"
          >
            Login
          </button>
        ...
        <Link href="/register" className="h-full w-full">
          <button className="px-2 py-1 border-[0.5px] border-gray-500 rounded-md w-full cursor-pointer bg-gray-800 text-white font-semibold text-[15px]">
            Register
          </button>
        </Link>
      </form>
